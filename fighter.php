...
<body>
    <div class="fondopantalla">
        ...
        <section class="section section1" id="section1">
            <img id="tamañoimagen1" src="./img/server1.png" alt="Imagen 1">
            <div>
                <h2>NEXUS</h2>
                <p>¡Nexus, la nueva era del roleplay! <br> Descúbrelo por ti mismo y sé parte de la historia.</p>
            </div>
        </section>
        ...
        <section class="section section3" id="section3">
            ...
            <div>
                ...
                <button href="login.php">JUGAR</button>
            </div>
        </section>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            // El event listener para manejar el scroll y el desplazamiento suave
            ...
            //  Event listener para el click en los enlaces del menú
